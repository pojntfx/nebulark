...
__attribute__((export_name("nebulark_ion_spark_construct")))
int nebulark_ion_spark_construct() {
  return 0;
}

__attribute__((export_name("nebulark_ion_spark_input_set_length"))) 
int nebulark_ion_spark_input_set_length(int length) { 
  return 0;
}

__attribute__((export_name("nebulark_ion_spark_input_set")))
int nebulark_ion_spark_input_set(int index, char input) {
    inputEncoded.push_back(input);
  return 0;
}

__attribute__((export_name("nebulark_ion_spark_open"))) 
int nebulark_ion_spark_open() {
  ...
  // }
 //REMOVE LATER
 string inputEncodedString = "eyJmaXJzdEFkZGVuZCI6IDMsICJzZWNvbmRBZGRlbmQiOiAyfQ==";
 string inputDecodedString;
  //std::vector<uint8_t> inputDecodedArray = base64::decode(inputEncodedString);
  bool decoder = Base64::Decode(inputEncodedString, &inputDecodedString);

  // string inputDecodedString = "";
  // for (int h = 0; h < sizeof(inputDecodedArray)/sizeof(inputDecodedArray[0]); h++) {
...
__attribute__((export_name("nebulark_ion_spark_ignite")))
...
__attribute__((export_name("nebulark_ion_spark_close")))
int nebulark_ion_spark_close() {
 string outputDecodedString = string("{\"sum\": ") + std::to_string(result) + "}";
...
__attribute__((export_name("nebulark_ion_spark_output_get_length")))
int nebulark_ion_spark_output_get_length() {
  
  return sizeof(outputEncoded)/sizeof(outputEncoded[0]);
};

__attribute__((export_name("nebulark_ion_spark_output_get")))
char nebulark_ion_spark_output_get(int index) {
 
  return outputEncoded[index];
}

__attribute__((export_name("nebulark_ion_spark_deconstruct")))
