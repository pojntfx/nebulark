  ...
  function run(path, options) {
    ...
    let callback =
      typeof options.callback !== "undefined"
        ...
        : function () {};
    let errorCallback =
      typeof options.errorCallback !== "undefined"
    ...
    xhr.onload = function () {
      ...
      WebAssembly.instantiate(response, importObj)
        .then(function (resultObject) {
          importObj.teavm.logString.memory =
            resultObject.instance.exports.memory;
